...
class Guidance(nn.Module):
    ...
    def forward(self, x):
        ...
        # sg11, sg12, sg13, sg14: 960, H/16, W/16
        x = self.conv11(x)
...
class GANet_small_deep(nn.Module):
    def __init__(self, max_disparity=192):
        super(GANet_small_deep, self).__init__()
        self.max_disparity = max_disparity
    ...
    def forward(self, x, y):
        ...
        x1 = self.conv_refine(rem)  # 32, H/8, W/8
