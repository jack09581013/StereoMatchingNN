...
class Guidance(nn.Module):
    def __init__(self):
        ...
        self.weight_gdf1 = nn.Conv2d(32, 1280, (3, 3), (1, 1), (1, 1), bias=False)
        self.weight_gdf2 = nn.Conv2d(32, 1280, (3, 3), (1, 1), (1, 1), bias=False)
        self.weight_gdf3 = nn.Conv2d(32, 1280, (3, 3), (1, 1), (1, 1), bias=False)

        self.weight_gdf11 = nn.Conv2d(48, 1920, (3, 3), (1, 1), (1, 1), bias=False)
        self.weight_gdf12 = nn.Conv2d(48, 1920, (3, 3), (1, 1), (1, 1), bias=False)
        self.weight_gdf13 = nn.Conv2d(48, 1920, (3, 3), (1, 1), (1, 1), bias=False)
        self.weight_gdf14 = nn.Conv2d(48, 1920, (3, 3), (1, 1), (1, 1), bias=False)
    ...
    def forward(self, x):
        ...
        # gdf11, gdf12, gdf13, gdf14: 1920, H/8, W/8
        # 1920 = 48*4*10
        x = self.conv11(x)
...
class CostAggregation(nn.Module):
    def __init__(self, maxdisp=192):
        ...
        self.gdf1 = GDF4_Block(32, 3)
        self.gdf2 = GDF4_Block(32, 3)
        self.gdf3 = GDF4_Block(32, 3)
        self.gdf11 = GDF4_Block(48, 3)
        self.gdf12 = GDF4_Block(48, 3)
        self.gdf13 = GDF4_Block(48, 3)
        self.gdf14 = GDF4_Block(48, 3)
...
class GDFNet_mdc4(nn.Module):
    def __init__(self, max_disparity=192):
        super(GDFNet_mdc4, self).__init__()
        self.max_disparity = max_disparity
